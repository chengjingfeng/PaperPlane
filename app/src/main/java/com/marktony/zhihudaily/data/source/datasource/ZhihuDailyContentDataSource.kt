...
interface ZhihuDailyContentDataSource {
    ...
    interface LoadZhihuDailyContentCallback {
        ...
        fun onContentLoaded(content: ZhihuDailyContent)

        fun onDataNotAvailable()

    }

    fun getZhihuDailyContent(id: Int, callback: LoadZhihuDailyContentCallback)

    fun saveContent(content: ZhihuDailyContent)
